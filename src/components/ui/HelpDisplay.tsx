  ...
  return (
    <div className="text-slate-300 space-y-2">
      ...
      <div className="ml-4 space-y-1">
        ...
        <div><span className="text-cyan-300">op &lt;id&gt;</span> - Open a note</div>
        <div><span className="text-cyan-300">mod &lt;id&gt;</span> - Modify a note</div>
        <div><span className="text-cyan-300">del &lt;id&gt; [-f]</span> - Delete a note</div>
